...
export default function Learn() {
    ...
    return (
        <div className="learn flex items-center justify-between gap-[2rem] w-[90%] mx-auto mt-[5rem]">
            <div className="learn_info">
                ...
                <h1 class="mt-[1.5rem] text-[2rem] font-bold">Empower Your Skills: Unveiling the Proficiencies You Will Master</h1>
                <p class="text-gray-600 font-semibold mt-[1.5rem] mb-[.75rem]">By the end of this course, you wil be able to:</p>
                        ...
                        learnSkills.map((skill, index) => {
                            return (
                                <div class="skill flex items-center gap-[.5rem]" key={index}>
                                    ...
                                    <p className="skill font-bold" key={index}>{skill}</p>
                                </div>
                            )
                        })
                    }
