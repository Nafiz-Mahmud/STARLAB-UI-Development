    ...
    <div className="hero flex flex-col-reverse md:flex-row mt-[2rem]  w-[90%] mx-auto">
      <div className="hero_info pr-[1rem] flex flex-col items-start justify-around">
        <div class="flex">
          ...
          <p class="font-bold text-green-500">THE MARKETING TOOLKIT IS HERE</p>
        </div>
        <h1 class="mt-[1rem] text-[1.5rem] md:text-[1.5rem] xl:text-[2.5rem] font-bold">
          Mastering Proven Strategies That Drive Real Results!
        </h1>
        <p class="font-bold xl:text-[1.2rem] text-gray-500 my-[2rem]">
        ...
        <button class="xl:text-[1.5rem] px-[1rem] py-[.5rem] my-[1rem] rounded-full bg-green-600 text-white font-bold hover:animate-pulse hover:scale-105 duration-300">
          Enroll Now {`>`}
        </button>
