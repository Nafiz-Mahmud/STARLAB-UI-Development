...
export default function HeroComp() {
    return (
        <div className="hero flex flex-col-reverse md:flex-row mt-[2rem]  w-[90%] mx-auto">
            <div className="hero_info pr-[1rem] flex flex-col items-start justify-around">
                <div class="flex">
                    <div class=" border-green-500 border-l-[.5rem] mr-[1rem]"></div>
                    <p class="font-bold text-green-500">THE MARKETING TOOLKIT</p>
                </div>
                <h1 class="mt-[1rem] text-[1.5rem] md:text-[1.5rem] xl:text-[2.5rem] font-bold">Mastering Proven Strategies That Drive Real Results!</h1>
                <p class="font-bold xl:text-[1.2rem] text-gray-500 my-[2rem]">Unleash the power of strategic marketing with our comprehensive course, designed to empower you with the skills and knowledge necessary to navigate the dynamic landscape of modern business.</p>
                <button class="xl:text-[1.5rem] px-[1rem] py-[.5rem] my-[1rem] rounded-full bg-green-600 text-white font-bold hover:animate-pulse hover:scale-105 duration-300">Enroll Now {`>`}</button>
