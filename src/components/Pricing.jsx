export default function Pricing() {
    return (
        <div className="pricing mt-[5rem] w-[90%] mx-auto">
            ...
            <h1 class="my-[2rem] font-bold text-[1.2rem] lg:text-[2rem] xl:text-[2.5rem]">Choose the pricing that works best for you</h1>
            <div className="pricing_info flex flex-col lg:flex-row gap-[2rem] items-start justify-between">
                <div className="pricing_monthly_info w-full p-[2rem] bg-gray-100 rounded-md shadow-xl">
                    <h1 class="text-[1.5rem] font-bold">Monthly Subscription</h1>
                    <p class="my-[1rem] lg:text-[1.2rem] font-semibold">Fuel your product workflow with more advanced research features.</p>
                    <span class="flex items-end">
                        <h1 class="font-bold text-[2rem]">$49</h1><p class="font-semibold">/Month</p>
                    </span>
                    <button class="font-semibold bg-green-500 lg:text-[1.2rem] text-white px-[1rem] py-[.5rem] rounded-full mt-[1rem]">Enroll Now {">"}</button>
                    <div class="flex  flex-col lg:text-[1.2rem] mt-[1rem] gap-[.5rem] font-semibold">
                ...
                <div className="pricing_one_time_info p-[2rem] w-full bg-gray-100 rounded-md shadow-xl relative">
                    ...
                    <p class="my-[1rem] font-semibold lg:text-[1.2rem]">Scale product research and learning across your company</p>
                    <span class="flex items-end">
